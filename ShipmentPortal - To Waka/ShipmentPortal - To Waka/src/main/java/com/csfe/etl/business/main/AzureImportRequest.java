...
@Component
public class AzureImportRequest {
	private static Logger logger = Logger.getLogger(AzureImportRequest.class);
	...
	public static void main(String args[]) {
		...
		AzureImportRequest main = context.getBean(AzureImportRequest.class);
	...
	public void processReq() {	
		logger.info("Start program - Import Azure data.");
		try {
			this.getService().processAzure(this.getUserName());
